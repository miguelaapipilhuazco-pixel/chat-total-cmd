...
app.get('/', (req, res) => {
  ...
  .middle-row { width: 100%; display: flex; flex-direction: row; items: center; justify-content: space-between; padding: 0 2px; box-sizing: border-box; }
  .braille-ico { color: #f59e0b; font-size: 24px; font-weight: bold; line-height: 1; }
  .señas-ico { font-size: 20px; }
  .texto-ico { font-size: 20px; font-weight: 900; font-family: serif; color: #f4f4f5; letter-spacing: -1px; }
  .flecha-ico { font-size: 11px; font-weight: 900; color: #52525b; transition: color 0.2s; }
  .flecha-ico:hover { color: #f59e0b; }
  .voz-ico { font-size: 20px; color: #f4f4f5; }
  .logo-circulo { width: 70px; height: 70px; background-color: rgba(9, 9, 11, 0.95); border: 2px solid rgba(245, 158, 11, 0.5); border-radius: 50%; display: flex; items: center; justify-content: center; box-shadow: 0 15px 20px rgba(0,0,0,0.4); overflow: hidden; padding: 8px; box-sizing: border-box; }
  ...
  <div id="modo-com" style="display: none; width: 110px; height: 160px; align-items: center; justify-content: center;">
