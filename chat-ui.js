...
export function obtenerInterfaz(userAgent, config, colorFondo, efectoBlur, estiloBorder, radioBordes) {
  ...
  /* INTERACCIÓN DINÁMICA: Escala e inyección de los tonos amarillos y dorados del logo */
  .icon-btn:hover { transform: scale(1.15); filter: brightness(1.2); }
  ...
  /* REGLAS DE SELECCIÓN EXCLUSIVAS PARA CADA SÍMBOLO INMERSIVO */
  .braille-ico { color: rgba(255, 255, 255, 0.7) !important; font-size: 32px; font-weight: bold; line-height: 1; height: 32px; }
  .braille-ico:hover { color: #fbbf24 !important; filter: drop-shadow(0 0 8px rgba(251,191,36,0.6)); }
  .braille-ico:active { color: #d97706 !important; }

  .senas-ico { font-size: 26px; width: 36px; height: 36px; filter: brightness(0) invert(1) opacity(0.7); }
  .senas-ico:hover { filter: none !important; transform: scale(1.15); filter: drop-shadow(0 0 8px rgba(245,158,11,0.5)) !important; }

  .texto-ico { font-size: 26px; font-weight: 900; font-family: serif; color: rgba(255, 255, 255, 0.7) !important; letter-spacing: -1px; width: 36px; height: 36px; }
  .texto-ico:hover { color: #f59e0b !important; filter: drop-shadow(0 0 8px rgba(245,158,11,0.6)); }
  .texto-ico:active { color: #d97706 !important; }

  .flecha-ico { font-size: 14px; font-weight: 900; color: rgba(255, 255, 255, 0.4); width: 20px; height: 20px; text-align: center; }
  .flecha-ico:hover { color: #fbbf24; }
  
  .voz-ico { font-size: 26px; color: rgba(255, 255, 255, 0.7) !important; height: 36px; filter: brightness(0) invert(1) opacity(0.7); }
  .voz-ico:hover { filter: none !important; transform: scale(1.15); filter: drop-shadow(0 0 8px rgba(251,191,36,0.5)) !important; }
